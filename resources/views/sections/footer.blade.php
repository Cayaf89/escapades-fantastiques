<footer class="w-full bg-beige pt-12 md:pt-16 pb-8">
    <div class="container mx-auto flex flex-col items-center justify-center">
        <div class="grid grid-cols-1 md:grid-cols-2">
            <div class="flex flex-col space-y-6 border-r-2 border-r-black pr-12">
                <div class="text-3xl font-bold !no-underline">
                    {!! $siteName !!}
                </div>
                <div>
                    <a href="tel:0648587569" class="flex items-center mb-4">
                        <svg class="size-6 mr-4" width="24" height="24" viewBox="0 0 24 24"
                    ...
                    <a href="mailto:commercial@escapadesfantastiques.com" class="flex items-center">
                        <svg class="size-6 mr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
...
{{--                        </a>--}}
            ...
            <div class="pl-12">
                {!! wp_nav_menu([
                    'menu' => 6,
                    'menu_class' => 'flex flex-col space-y-4 text-lg font-bold [&_a]:!no-underline',
                    'echo' => false,
                ]) !!}
            </div>
        </div>
